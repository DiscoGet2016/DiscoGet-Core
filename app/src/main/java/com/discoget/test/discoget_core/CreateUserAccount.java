...
public class CreateUserAccount extends AppCompatActivity {
    ...
    private boolean debug = true;  // change to false for production
    ...
    */
    ...
    private void saveUserCollection(String username, String userToken) {
        ...
        Toast.makeText(this,"collection list",Toast.LENGTH_LONG).show();
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(getBaseContext(),discogsJSONString,Toast.LENGTH_LONG).show();
