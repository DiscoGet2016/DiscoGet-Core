 ...
 */
public class FriendsWantList extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(b!=null)
        {
            ...
            friendsname = (String) b.get("friendsname");
        ...
        String paneTitle = friendsname+"'s" + " " + listType;
       ...
       /* my_toolbar.findViewById(R.id.my_toolbar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                PopupMenu popup = new PopupMenu(FriendsWantList.this, v);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.menu_profile:
                                goToNextScreen = new Intent (FriendsWantList.this,UserProfile.class);
                            ...
                            case R.id.menu_search:
                                goToNextScreen = new Intent (FriendsWantList.this,SearchActivity.class);
                                goToNextScreen.putExtra("username",username);
                                goToNextScreen.putExtra("password",password);
                            ...
                            case R.id.menu_collection:
                                goToNextScreen = new Intent (FriendsWantList.this,FriendsWantList.class);
                                goToNextScreen.putExtra("username",username);
                                goToNextScreen.putExtra("password",password);
                            ...
                            case R.id.menu_friends:
                                goToNextScreen = new Intent (FriendsWantList.this,Friends.class);
                                goToNextScreen.putExtra("username",username);
                                goToNextScreen.putExtra("password",password);
                                //goToNextScreen.putExtra("listType","Collection");
                            ...
                            case R.id.menu_logout:
                                goToNextScreen = new Intent (FriendsWantList.this,AccountAccess.class);
                                startActivity(goToNextScreen);
                       ...
                       //
                                goToNextScreen = new Intent (FriendsWantList.this,ActivityHome.class);
                                startActivity(goToNextScreen);
        ...
        */
        ...
        theListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int menuSelected, long l) {
                ...
                Toast.makeText(FriendsWantList.this,menuItemSelected, Toast.LENGTH_SHORT).show();
    ...
    public void goHome(View view) {
        ...
        Toast.makeText(FriendsWantList.this,toastString, Toast.LENGTH_SHORT).show();
